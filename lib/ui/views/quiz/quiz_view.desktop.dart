    ...
    return ViewModelBuilder<QuizViewModel>.reactive(
      ...
      builder: (context, viewModel, child) => SizedBox.expand(
        child: SingleChildScrollView(
          child: Padding(
            padding:
                const EdgeInsets.symmetric(horizontal: 69.0, vertical: 30.0),
            child: Row(
                    ...
                    children: [
                      ...
                      if (viewModel.isLoading)
                        ...
                        QuizCard(
                          ...
                          correctIndex:
                              viewModel.currentQuestion?.correctIndex ?? 0,
                              ...
                              return GestureDetector(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        viewModel.getQuestionStatusColor(index),
                                    borderRadius: BorderRadius.circular(8),
                                  ),
                                  child: Row(
                                    children: [
                                      Icon(
                                        viewModel.getQuestionStatusIcon(index),
                                        size: 16,
                                        color: viewModel.getQuestionStatusIcon(
                                                    index) ==
                                                Icons.check_circle
                                            ? kcLimeCCB
